...
const vars = [`SPLIT_SIGNING_KEY:${SIGNING_KEY}`, "SPLIT_WS_URL:ws://127.0.0.1:8765/", "SPLIT_PLAN_URL:http://127.0.0.1:8765/plan", "SPLIT_ALLOWED_ORIGINS:http://127.0.0.1:8799", "GIT_SHA:e2e"];
